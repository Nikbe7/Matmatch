...
function result(overrides: Partial<TonightResult> = {}): TonightResult {
  return {
    template: { id: "kycklinggryta", name: "Kycklinggryta", blurb: "Testblurb.", cost_tier: "mid", prep_time_band: "20-40min", prep_minutes: 30, cuisine: "swedish_nordic" },
    ingredients: [
...
describe("ShoppingList", () => {
  ...
  it("starts a fresh list for a different template id rather than merging", async () => {
    ...
    render(
      <ShoppingList
        result={result({
          template: { id: "fisksoppa", name: "Fisksoppa", blurb: "Testblurb.", cost_tier: "budget", prep_time_band: "<20min", prep_minutes: 15, cuisine: "swedish_nordic" },
