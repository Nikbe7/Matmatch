...
- Below it: three lightweight entry points if the user wants to redirect instead of accepting:
  - "Something cheaper"
  - "Use what I have"
  - "Something different"
...
1. **Pick an intent chip**: Dinner idea / Cheap / Use what I have / High-protein / Meal prep & lunch boxes / Surprise me
2. **Pick a main ingredient** — either choose one directly (e.g., "chicken") or tap "suggest for me" (AI/engine suggests based on season, price tier, and household history)
...
4. **Direction cards** — 3 options shown as cards, not chat text:
   ...
   - "Chicken fried rice"
   Each card shows a one-line description and a rough cost tier indicator (₤ / ₤₤ / ₤₤₤), not a specific invented price.
